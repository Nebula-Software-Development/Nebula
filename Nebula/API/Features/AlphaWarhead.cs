// -----------------------------------------------------------------------
// <copyright file=AlphaWarhead.cs company="Nebula-Software-Development">
...
namespace Nebula.API.Features
{
    ...
    public static class AlphaWarhead
    {
        ...
        /// </summary>
        public static void CancelDetonation(Player disabler = null)
        {
            Controller.CancelDetonation(disabler?.ReferenceHub);
        }
        ...
        public static void ForceTime(float time)
        {
            Controller.ForceTime(time);
        }
        ...
        public static void StartDetonation(bool isAutomatic = false, bool supressSubtitles = false,
            ReferenceHub playerTriggering = null)
        {
            Controller.StartDetonation(isAutomatic, supressSubtitles, playerTriggering);
        }
    }
}