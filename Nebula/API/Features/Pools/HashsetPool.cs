// -----------------------------------------------------------------------
// <copyright file=HashsetPool.cs company="Nebula-Software-Development">
...
namespace Nebula.API.Features.Pools
{
    ...
    public class HashSetPool<T>
    {
        ...
        {
            return NorthwoodLib.Pools.HashSetPool<T>.Shared.Rent();
        }
        ...
        {
            NorthwoodLib.Pools.HashSetPool<T>.Shared.Return(obj);
        }
