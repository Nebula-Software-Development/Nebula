// -----------------------------------------------------------------------
// <copyright file=Scp018Projectile.cs company="Nebula-Software-Development">
...
namespace Nebula.API.Features.Items.Projectiles
{
    public class Scp018Projectile : TimedExplosiveProjectile
    {
        ...
        public void RegisterBounce(float velocity, Vector3 point)
        {
            Base.RegisterBounce(velocity, point);
        }
    }
}