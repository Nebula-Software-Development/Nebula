// -----------------------------------------------------------------------
// <copyright file=BodyArmor.cs company="Nebula-Software-Development">
...
namespace Nebula.API.Features.Items
{
    ...
    public class BodyArmor : Item
    {
        ...
        /// <param name="armor">
        ///     An output parameter that will store the retrieved <see cref="BodyArmorBase" /> object if
        ///     successful.
        /// </param>
        public static void TryGetArmor(Inventory inventory, out BodyArmorBase armor)
        {
            inventory.TryGetBodyArmor(out armor);
        }
        ...
        public static float ProcessDamage(int efficacy, float damage, int bulletPenetrationPercent)
        {
            return BodyArmorUtils.ProcessDamage(efficacy, damage, bulletPenetrationPercent);
        }
    }
}