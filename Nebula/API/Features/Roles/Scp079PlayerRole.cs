// -----------------------------------------------------------------------
// <copyright file=Scp079PlayerRole.cs company="Nebula-Software-Development">
...
namespace Nebula.API.Features.Roles
{
    ...
    public class Scp079PlayerRole : Role
    {
        ...
        /// </summary>
        public Scp079Speaker CurrentSpeaker =>
            Scp079Speaker.TryGetSpeaker(Camera.Base, out Scp079Speaker speaker) ? speaker : null;
        ...
        {
            TierManager.ServerGrantExperience(amount, Scp079HudTranslation.Experience);
        }
        ...
        {
            return Base.IsInIdleRange(teslaGate);
        }
