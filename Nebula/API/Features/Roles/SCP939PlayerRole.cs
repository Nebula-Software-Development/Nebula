// -----------------------------------------------------------------------
// <copyright file=Scp939PlayerRole.cs company="Nebula-Software-Development">
...
namespace Nebula.API.Features.Roles
{
    ...
    public class Scp939PlayerRole : FpcRoleBase
    {
        ...
        public void SaveRecording(ReferenceHub hub)
        {
            MimicryRecorder.SaveRecording(hub);
        }
        ...
        public void SaveRecording(Player player)
        {
            MimicryRecorder.SaveRecording(player.ReferenceHub);
        }
        ...
        public void RemoveRecordingOfPlayer(ReferenceHub hub)
        {
            MimicryRecorder.RemoveRecordingsOfPlayer(hub);
        }
        ...
        public void RemoveRecordingOfPlayer(Player player)
        {
            MimicryRecorder.RemoveRecordingsOfPlayer(player.ReferenceHub);
        }
