// -----------------------------------------------------------------------
// <copyright file=Scp049Handlers.cs company="Nebula-Software-Development">
...
namespace Nebula.Events.Handlers
{
    public static class Scp049Handlers
    {
        ...
        internal static void OnSense(Scp049UseSenseEvent ev)
        {
            Sense.CallEvent(ev);
        }

        internal static void OnCall(Scp049UseCallEvent ev)
        {
            Call.CallEvent(ev);
        }

        internal static void OnStartResurrect(Scp049StartResurrectEvent ev)
        {
            StartResurrect.CallEvent(ev);
        }

        internal static void OnFinishResurrect(Scp049FinishResurrectEvent ev)
        {
            FinishResurrect.CallEvent(ev);
        }

        internal static void OnCancelResurrect(Scp049CancelResurrectEvent ev)
        {
            CancelResurrect.CallEvent(ev);
        }

        internal static void OnLoseSenseTarget(Scp049LoseSenseTargetEvent ev)
        {
            LoseSenseTarget.CallEvent(ev);
        }
    }
}