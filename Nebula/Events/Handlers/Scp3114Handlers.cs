// -----------------------------------------------------------------------
// <copyright file=Scp3114Handlers.cs company="Nebula-Software-Development">
...
namespace Nebula.Events.Handlers
{
    public static class Scp3114Handlers
    {
        ...
        internal static void OnDisguising(Scp3114DisguisingEvent ev)
        {
            Disguising.CallEvent(ev);
        }

        internal static void OnDisguised(Scp3114DisguisedEvent ev)
        {
            Disguised.CallEvent(ev);
        }

        internal static void OnStrangle(Scp3114StranglingEvent ev)
        {
            Strangling.CallEvent(ev);
        }

        internal static void OnReveal(Scp3114RevealEvent ev)
        {
            Reveal.CallEvent(ev);
        }

        internal static void OnRevealed(Scp3114RevealedEvent ev)
        {
            Revealed.CallEvent(ev);
        }
    }
}