// -----------------------------------------------------------------------
// <copyright file=FinishRevive.cs company="Nebula-Software-Development">
...
namespace Nebula.Events.Patches.SCPs.Scp049
{
    ...
    {
        [HarmonyTranspiler]
        private static IEnumerable<CodeInstruction> OnCompleteRevive(IEnumerable<CodeInstruction> instructions,
            ILGenerator generator)
        {
            ...
            newInstructions.InsertRange(index, new CodeInstruction[]
            {
                ...
                new(OpCodes.Ldarg_0),
                new(OpCodes.Callvirt,
                    PropertyGetter(typeof(Scp049ResurrectAbility), nameof(Scp049ResurrectAbility.CurRagdoll))),
                ...
                new(OpCodes.Callvirt,
                    PropertyGetter(typeof(Scp049FinishResurrectEvent), nameof(Scp049FinishResurrectEvent.IsCancelled))),
