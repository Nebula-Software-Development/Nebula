// -----------------------------------------------------------------------
// <copyright file=RevealPatch.cs company="Nebula-Software-Development">
...
namespace Nebula.Events.Patches.SCPs.Scp3114
{
    ...
    {
        [HarmonyTranspiler]
        private static IEnumerable<CodeInstruction> OnReveal(IEnumerable<CodeInstruction> instructions,
            ILGenerator generator)
        {
            ...
            newInstructions.InsertRange(0, new CodeInstruction[]
            {
                ...
                new(OpCodes.Callvirt,
                    PropertyGetter(typeof(Scp3114RevealEvent), nameof(Scp3114RevealEvent.IsCancelled))),
    ...
    {
        [HarmonyTranspiler]
        private static IEnumerable<CodeInstruction> OnUpdateReveal(IEnumerable<CodeInstruction> instructions,
            ILGenerator generator)
        {
            List<CodeInstruction> newInstructions =
                EventManager.CheckPatchInstructions<RevealUpdatePatch>(21, instructions);
