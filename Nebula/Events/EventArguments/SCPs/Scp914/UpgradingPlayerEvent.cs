// -----------------------------------------------------------------------
// <copyright file=UpgradingPlayerEvent.cs company="Nebula-Software-Development">
...
namespace Nebula.Events.EventArguments.SCPs.Scp914
{
    ...
    {
        public UpgradingPlayerEvent(ReferenceHub ply, bool upgradeInventory, bool heldOnly,
            Scp914KnobSetting knobSetting, Vector3 moveVector)
        {
