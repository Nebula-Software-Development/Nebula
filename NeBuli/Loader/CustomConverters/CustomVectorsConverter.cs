...
public sealed class CustomVectorsConverter : IYamlTypeConverter
{
    ...
    public object ReadYaml(IParser parser, Type type)
    {
        ...
        {
            Type t when t == typeof(Vector2) && coordinates.Count == 2 => new Vector2(coordinates[0], coordinates[1]),
            Type t when t == typeof(Vector3) && coordinates.Count == 3 => new Vector3(coordinates[0], coordinates[1], coordinates[2]),
            Type t when t == typeof(Vector4) && coordinates.Count == 4 => new Vector4(coordinates[0], coordinates[1], coordinates[2], coordinates[3]),
