...
{
    [HarmonyTranspiler]
    private static IEnumerable<CodeInstruction> OnCalming(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
    {
        ...
        newInstructions.InsertRange(0, new CodeInstruction[]
        {
            ...
            new(OpCodes.Ldloc_S, calming.LocalIndex),
            new(OpCodes.Callvirt, PropertyGetter(typeof(Scp096CalmingEvent), nameof(Scp096CalmingEvent.IsCancelled))),
            new(OpCodes.Brtrue_S, retLabel),
            new(OpCodes.Ldloc_S, calming.LocalIndex),
            new(OpCodes.Callvirt, PropertyGetter(typeof(Scp096CalmingEvent), nameof(Scp096CalmingEvent.ClearingTime))),
