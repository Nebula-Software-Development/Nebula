// -----------------------------------------------------------------------
// <copyright file=EnragingPatch.cs company="Nebula-Software-Development">
...
namespace Nebula.Events.Patches.SCPs.Scp096
{
    ...
    {
        [HarmonyTranspiler]
        private static IEnumerable<CodeInstruction> OnEnraging(IEnumerable<CodeInstruction> instructions,
            ILGenerator generator)
        {
            List<CodeInstruction> newInstructions =
                EventManager.CheckPatchInstructions<EnragingPatch>(37, instructions);
            ...
            newInstructions.InsertRange(index, new[]
            {
                ...
                new(OpCodes.Callvirt,
                    PropertyGetter(typeof(Scp096EnragingEvent), nameof(Scp096EnragingEvent.IsCancelled))),
                new(OpCodes.Brtrue_S, retLabel),
                new(OpCodes.Ldloc_S, enraging.LocalIndex),
                new(OpCodes.Callvirt,
                    PropertyGetter(typeof(Scp096EnragingEvent), nameof(Scp096EnragingEvent.Duration))),
