// -----------------------------------------------------------------------
// <copyright file=DisgusingAndDisguisedPatch.cs company="Nebula-Software-Development">
...
namespace Nebula.Events.Patches.SCPs.Scp3114
{
    ...
    {
        [HarmonyTranspiler]
        private static IEnumerable<CodeInstruction> OnDisguising(IEnumerable<CodeInstruction> instructions,
            ILGenerator generator)
        {
            List<CodeInstruction> newInstructions =
                EventManager.CheckPatchInstructions<DisgusingAndDisguisedPatch>(21, instructions);
            ...
            newInstructions.InsertRange(0, new CodeInstruction[]
            {
                ...
                new(OpCodes.Callvirt,
                    PropertyGetter(typeof(Scp3114DisguisingEvent), nameof(Scp3114DisguisingEvent.IsCancelled))),
