...
internal class UpgradingItemPatch
{
    ...
    private static IEnumerable<CodeInstruction> OnItemUpgrade(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
    {
        ...
        newInstructions.InsertRange(index, new CodeInstruction[]
        {
            ...
            new(OpCodes.Ldloc_S, @event.LocalIndex),
            new(OpCodes.Callvirt, PropertyGetter(typeof(UpgradingItemEvent), nameof(UpgradingItemEvent.KnobSetting))),
            new(OpCodes.Starg_S, 3),
            new(OpCodes.Ldloc_S, @event.LocalIndex),
            new(OpCodes.Callvirt, PropertyGetter(typeof(UpgradingItemEvent), nameof(UpgradingItemEvent.UpgradeDropped))),
