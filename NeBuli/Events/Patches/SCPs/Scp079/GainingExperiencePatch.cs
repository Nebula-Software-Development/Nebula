// -----------------------------------------------------------------------
// <copyright file=GainingExperiencePatch.cs company="NebuliTeam">
...
{
    [HarmonyTranspiler]
    private static IEnumerable<CodeInstruction> OnGainingExperience(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
    {
        List<CodeInstruction> newInstructions = EventManager.CheckPatchInstructions<GainingExperiencePatch>(23, instructions);
        ...
        newInstructions.InsertRange(0, new CodeInstruction[]
        {
            ...
            new(OpCodes.Ldloc_S, gainingExperience.LocalIndex),
            new(OpCodes.Callvirt, PropertyGetter(typeof(Scp079GainingExperienceEvent), nameof(Scp079GainingExperienceEvent.IsCancelled))),
            new(OpCodes.Brtrue_S, retLabel),
            new(OpCodes.Ldloc_S, gainingExperience.LocalIndex),
            new(OpCodes.Callvirt, PropertyGetter(typeof(Scp079GainingExperienceEvent), nameof(Scp079GainingExperienceEvent.Amount))),
            new(OpCodes.Starg_S, 1),
            new(OpCodes.Ldloc_S, gainingExperience.LocalIndex),
            new(OpCodes.Callvirt, PropertyGetter(typeof(Scp079GainingExperienceEvent), nameof(Scp079GainingExperienceEvent.Reason))),
