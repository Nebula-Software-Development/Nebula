...
{
    [HarmonyTranspiler]
    private static IEnumerable<CodeInstruction> OnInteractingTesla(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
    {
        List<CodeInstruction> newInstructions = EventManager.CheckPatchInstructions<InteractingTeslaPatch>(58, instructions);
        ...
        newInstructions.InsertRange(index, new[]
        {
            ...
            new(OpCodes.Ldloc_S, interactingTesla.LocalIndex),
            new(OpCodes.Callvirt, PropertyGetter(typeof(Scp079InteractingTeslaEvent), nameof(Scp079InteractingTeslaEvent.IsCancelled))),
