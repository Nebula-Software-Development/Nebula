// -----------------------------------------------------------------------
// <copyright file=UseBreakneck.cs company="Nebula-Software-Development">
...
namespace Nebula.Events.Patches.SCPs.Scp173
{
    ...
    {
        [HarmonyTranspiler]
        private static IEnumerable<CodeInstruction> OnTogglingBreakneck(IEnumerable<CodeInstruction> instructions,
            ILGenerator generator)
        {
            ...
            newInstructions.InsertRange(index, new[]
            {
                ...
                new(OpCodes.Callvirt,
                    PropertyGetter(typeof(Scp173BreakneckSpeedsAbility), nameof(Scp173BreakneckSpeedsAbility.Owner))),
                ...
                new(OpCodes.Callvirt,
                    PropertyGetter(typeof(Scp173ToggleBreakneckSpeedEvent),
                        nameof(Scp173ToggleBreakneckSpeedEvent.IsCancelled))),
