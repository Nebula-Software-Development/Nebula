// -----------------------------------------------------------------------
// <copyright file=SpawningBloodPatch.cs company="Nebula-Software-Development">
...
namespace Nebula.Events.Patches.Server
{
    ...
    {
        [HarmonyTranspiler]
        private static IEnumerable<CodeInstruction> OnPlacingBlood(IEnumerable<CodeInstruction> instructions,
            ILGenerator generator)
        {
            List<CodeInstruction> newInstructions =
                EventManager.CheckPatchInstructions<SpawningBloodPatch>(22, instructions);
            ...
            newInstructions.InsertRange(index, new[]
            {
                ...
                new(OpCodes.Callvirt,
                    PropertyGetter(typeof(SpawningBloodEvent), nameof(SpawningBloodEvent.IsCancelled))),
                ...
                new(OpCodes.Ldloc_S, spawning.LocalIndex),
                new(OpCodes.Callvirt,
                    PropertyGetter(typeof(SpawningBloodEvent), nameof(SpawningBloodEvent.RaycastHit))),
