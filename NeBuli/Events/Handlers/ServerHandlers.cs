// -----------------------------------------------------------------------
// <copyright file=ServerHandlers.cs company="Nebula-Software-Development">
...
namespace Nebula.Events.Handlers
{
    public static class ServerHandlers
    {
        ...
        internal static void OnWarheadDetonated(WarheadDetonatingEvent ev)
        {
            WarheadDetonated.CallEvent(ev);
        }

        internal static void OnMapGenerated()
        {
            MapGenerated.CallEmptyEvent();
        }

        internal static void OnWaitingForPlayers()
        {
            WaitingForPlayers.CallEmptyEvent();
        }

        internal static void OnSpawningItem(SpawningItemEvent ev)
        {
            SpawningItem.CallEvent(ev);
        }

        internal static void OnSpawningBlood(SpawningBloodEvent ev)
        {
            SpawningBlood.CallEvent(ev);
        }

        internal static void OnWarheadStarting(WarheadStartingEvent ev)
        {
            WarheadStarting.CallEvent(ev);
        }

        internal static void OnWarheadStopping(WarheadStoppingEvent ev)
        {
            WarheadStopping.CallEvent(ev);
        }
    }
}