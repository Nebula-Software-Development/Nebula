...
{
    public static EventManager.CustomEventHandler<Scp939PlaceCloud> PlaceCloud;
    
    public static EventManager.CustomEventHandler<Scp939CancelCloudPlacement> CancelCloudPlacement;
    
    public static EventManager.CustomEventHandler<Scp939PlaceMimicPoint> PlaceMimicPoint;
    
    public static EventManager.CustomEventHandler<Scp939RemoveMimicPoint> RemoveMimicPoint;
    
    public static EventManager.CustomEventHandler<Scp939PlaySound> PlaySound;
    
    public static EventManager.CustomEventHandler<Scp939PlayVoice> PlayVoice;
    
    public static EventManager.CustomEventHandler<Scp939SavePlayerVoice> SaveVoice;
    
    public static EventManager.CustomEventHandler<Scp939RemoveSavedVoice> RemoveVoice;
    
    public static EventManager.CustomEventHandler<Scp939UseLunge> UseLunge;
    
    public static EventManager.CustomEventHandler<Scp939ToggleFocus> ToggleFocus;
    
    public static EventManager.CustomEventHandler<Scp939Attack> Attack;
