// -----------------------------------------------------------------------
// <copyright file=Scp079Handlers.cs company="Nebula-Software-Development">
...
namespace Nebula.Events.Handlers
{
    public static class Scp079Handlers
    {
        ...
        internal static void OnScp079Pinging(Scp079PingingEvent ev)
        {
            Pinging.CallEvent(ev);
        }

        internal static void OnScp079LosingSignal(Scp079LosingSignalEvent ev)
        {
            LosingSignal.CallEvent(ev);
        }

        internal static void OnScp079GainingExpereince(Scp079GainingExperienceEvent ev)
        {
            GainingExperience.CallEvent(ev);
        }

        internal static void OnScp079GainingLevel(Scp079GainingLevelEvent ev)
        {
            GainingLevel.CallEvent(ev);
        }

        internal static void OnScp079ChangingCamera(Scp079ChangingCameraEvent ev)
        {
            ChangingCamera.CallEvent(ev);
        }

        internal static void OnScp079InteractingTesla(Scp079InteractingTeslaEvent ev)
        {
            InteractingTesla.CallEvent(ev);
        }
    }
}