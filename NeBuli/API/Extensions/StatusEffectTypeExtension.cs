// -----------------------------------------------------------------------
// <copyright file=StatusEffectTypeExtension.cs company="Nebula-Software-Development">
...
namespace Nebula.API.Extensions
{
    ...
    public static class StatusEffectTypeExtension
    {
        ...
        public static StatusEffect GetStatusEffectType(this StatusEffectBase statusEffectBase)
        {
            return statusEffectBase switch
            {
        ...
        public static Type EffectToType(this StatusEffect effect)
        {
        ...
        /// </summary>
        public static bool IsHealing(this StatusEffect effect)
        {
            return typeof(IHealablePlayerEffect).IsAssignableFrom(effect.EffectToType());
        }
    }
}