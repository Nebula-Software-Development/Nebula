...
public class AdminToy
{
    ...
    public Quaternion Rotation
    {
        get
        {
            ...
            return new Quaternion(lowPrecisionQuaternion._x, lowPrecisionQuaternion._y, lowPrecisionQuaternion._z, lowPrecisionQuaternion._w);
        }
        set
        {
    ...
    public static AdminToy Get(SLAdminToy toy) => Utilites.AdminToys.FirstOrDefault(x => x.Base == toy);

    /// <summary>
    /// Spawns the toy.
    /// </summary>
    public void SpawnToy() => NetworkServer.Spawn(GameObject);

    /// <summary>
    /// Despawns the toy.
    /// </summary>
    public void UnspawnToy() => NetworkServer.UnSpawn(GameObject);
