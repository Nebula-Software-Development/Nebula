// -----------------------------------------------------------------------
// <copyright file=ShootingTargetToy.cs company="Nebula-Software-Development">
...
namespace Nebula.API.Features.AdminToys
{
    ...
    public class ShootingTargetToy : AdminToy
    {
        ...
        /// </summary>
        public static ShootingTargetToy Get(SLTarget primitiveObjectToy)
        {
            return Utilites.AdminToys
                       .FirstOrDefault(x => x.Base == primitiveObjectToy) as ShootingTargetToy ??
                   new ShootingTargetToy(primitiveObjectToy);
        }

        /// <summary>
        ///     Creates a new <see cref="ShootingTargetToy" />.
        /// </summary>
        public static ShootingTargetToy Create(ShootingTargetToyType type, Vector3 position = default,
            Quaternion rotation = default, Vector3 scale = default, bool spawn = true)
        {
            ShootingTargetToy shootingTargetToy = type switch
            {
                ShootingTargetToyType.DClass => new ShootingTargetToy(
                    Object.Instantiate(ToyUtilities.DClassShootingTarget)),
                ShootingTargetToyType.Binary => new ShootingTargetToy(
                    Object.Instantiate(ToyUtilities.BinaryShootingTarget)),
