// -----------------------------------------------------------------------
// <copyright file=Elevator.cs company="Nebula-Software-Development">
...
namespace Nebula.API.Features.Map
{
    ...
    public class Elevator
    {
        ...
        public void SetInnerDoorState(bool state)
        {
            Base.SetInnerDoor(state);
        }
        ...
        public void RefreshLocks(ElevatorManager.ElevatorGroup elevatorGroup, ElevatorDoor door)
        {
            Base.RefreshLocks(elevatorGroup, door);
        }
        ...
        {
            return Dictionary.TryGetValue(elevatorBase, out Elevator elevator) ? elevator : new Elevator(elevatorBase);
        }
    }
}