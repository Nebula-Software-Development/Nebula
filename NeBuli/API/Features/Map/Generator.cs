// -----------------------------------------------------------------------
// <copyright file=Generator.cs company="Nebula-Software-Development">
...
namespace Nebula.API.Features.Map
{
    public class Generator
    {
        ...
        /// </summary>
        public GeneratorState GeneratorState => (GeneratorState)Base._flags;
        ...
        {
            return Dictionary.TryGetValue(generator, out Generator gen) ? gen : new Generator(generator);
        }
        ...
        public void Interact(Player player, byte colliderId)
        {
            Base.ServerInteract(player.ReferenceHub, colliderId);
        }

        public void HasFlag(byte flags, Scp079Generator.GeneratorFlags flag)
        {
            Base.HasFlag(flags, flag);
        }

        public void HasFlag(byte flags, GeneratorState flag)
        {
            Base.HasFlag(flags, (Scp079Generator.GeneratorFlags)flag);
        }
        ...
        public void SetFlag(Scp079Generator.GeneratorFlags flag, bool state)
        {
            Base.ServerSetFlag(flag, state);
        }
        ...
        /// <param name="flag">The flag to set.</param>
        /// <param name="state">The state to set.</param>
        public void SetFlag(GeneratorState flag, bool state)
        {
            Base.ServerSetFlag((Scp079Generator.GeneratorFlags)flag, state);
        }
    }
}