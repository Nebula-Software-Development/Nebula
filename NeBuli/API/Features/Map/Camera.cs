// -----------------------------------------------------------------------
// <copyright file=Camera.cs company="Nebula-Software-Development">
...
namespace Nebula.API.Features.Map
{
    ...
    public class Camera
    {
        ...
        /// <summary>
        ///     Gets the <see cref="Enum.CameraType" /> of the camera.
        /// </summary>
        public CameraType Type { get; }

        /// <summary>
        ///     Tries to get a <see cref="Camera" /> with the specified <see cref="CameraBase" />. If none are found, it creates
        ///     one.
        /// </summary>
        /// <param name="camera"></param>
        /// <returns></returns>
        public static Camera Get(CameraBase camera)
        {
            return Dictionary.TryGetValue(camera, out Camera baseCamera) ? baseCamera : new Camera(camera);
        }
        ...
        public static Camera GetType(CameraType cameraType)
        {
            return List.FirstOrDefault(x => x.Type == cameraType);
        }
