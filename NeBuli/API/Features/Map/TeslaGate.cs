// -----------------------------------------------------------------------
// <copyright file=TeslaGate.cs company="Nebula-Software-Development">
...
namespace Nebula.API.Features.Map
{
    ...
    public class TeslaGate
    {
        ...
        /// <returns></returns>
        public bool IsPlayerInHurtingRange(Player player)
        {
            return Base.PlayerInRange(player.ReferenceHub);
        }
        ...
        {
            return Base.IsInIdleRange(player.ReferenceHub);
        }
        ...
        {
            return Dictionary.TryGetValue(teslaGate, out TeslaGate tesla) ? tesla : new TeslaGate(teslaGate);
        }
        ...
        public static void TriggerTeslaGate(TeslaGate gate)
        {
            gate.Trigger();
        }
        ...
        /// </summary>
        public static void ForceTriggerTeslaGate(TeslaGate gate)
        {
            gate.ForceTrigger();
        }
    }
