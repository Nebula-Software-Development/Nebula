...
namespace Nebuli.API.Features.Player
{
    ...
    public class NebuliNpc : NebuliPlayer
    {
        ...
        {
            GameObject newPlayer = GameObject.Instantiate(NetworkManager.singleton.playerPrefab);
            ...
            {
                Log.Debug("Safe to ignore, error caused by setting NPC role --->" + e);
            }
            ...
            {
                Log.Debug("Safe to ignore, error caused by setting NPC UserID --->" + e);
            }
