// -----------------------------------------------------------------------
// <copyright file=AttachmentIdentity.cs company="Nebula-Software-Development">
...
namespace Nebula.API.Features.Structs
{
    ...
    public readonly struct AttachmentIdentity
    {
        ...
        {
            return Firearm.AvailableAttachments[type]
        ...
        {
            return left.Name == right.Name && left.Code == right.Code && left.Slot == right.Slot;
        }
        ...
        /// <returns>
        ///     <see langword="true" /> if <see cref="AttachmentIdentity" /> and this instance represent the same value;
