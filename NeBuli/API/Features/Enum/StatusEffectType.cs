// -----------------------------------------------------------------------
// <copyright file=StatusEffectType.cs company="NebuliTeam">
...
public enum StatusEffect
{
    ...
    /// <summary>
    /// Effect given to the player when their Field of View (FOV) is reduced, they receive infinite stamina, and underwater sound is simulated.
    /// </summary>
    Invigorated,
    ...
    /// <summary>
    /// Effect given to the player when they are inflicted with damage every 5 seconds, starting with low damage and increasing over time.
    /// </summary>
    Poisoned,
