// -----------------------------------------------------------------------
// <copyright file=Scp3114PlayerRole.cs company="Nebula-Software-Development">
...
namespace Nebula.API.Features.Roles
{
    ...
    public class Scp3114PlayerRole : FpcRoleBase
    {
        ...
        public bool IsCloseToRagdoll(Vector3 position)
        {
            return Disguise.IsCloseEnough(Position, position);
        }
