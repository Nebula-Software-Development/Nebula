// -----------------------------------------------------------------------
// <copyright file=Intercom.cs company="Nebula-Software-Development">
...
namespace Nebula.API.Features
{
    ...
    public static class Intercom
    {
        ...
        /// </summary>
        public static Player CurrentIntercomSpeaker =>
            !IsIntercomInUse ? null : Player.Get(BaseIntercom._singleton._curSpeaker);
        ...
        public static void InitiateIntercomSound(bool isStartingSound)
        {
            BaseIntercom._singleton.RpcPlayClip(isStartingSound);
        }
        ...
        {
            CurrentState = IntercomState.Ready;
        }

        /// <summary>
        ///     Times out the intercom operation.
        /// </summary>
        public static void TimeoutIntercom()
        {
            CurrentState = IntercomState.Cooldown;
        }
    }
}