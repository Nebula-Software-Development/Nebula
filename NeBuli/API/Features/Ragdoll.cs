// -----------------------------------------------------------------------
// <copyright file=Ragdoll.cs company="Nebula-Software-Development">
...
namespace Nebula.API.Features
{
    ...
    public class Ragdoll
    {
        ...
        internal Ragdoll(BasicRagdoll basicRagdoll)
        {
            ...
            if (basicRagdoll is DynamicRagdoll)
            {
                IsDynamic = true;
            }
        }
        ...
        public Vector3 StartPosition
        {
            ...
            set => RagdollData = new RagdollData(ReferenceHub, DamageHandlerBase, RoleTypeId, value, RagdollRotation,
                RagdollName, CreationTime);
        }
        ...
        public RoleTypeId RoleTypeId
        {
            ...
            set => RagdollData = new RagdollData(ReferenceHub, DamageHandlerBase, value, StartPosition, RagdollRotation,
                RagdollName, CreationTime);
        }
        ...
        public DamageHandlerBase DamageHandlerBase
        {
            ...
            set => RagdollData = new RagdollData(ReferenceHub, value, RoleTypeId, StartPosition, RagdollRotation,
                RagdollName, CreationTime);
        }
        ...
        public string RagdollName
        {
            ...
            set => RagdollData = new RagdollData(ReferenceHub, DamageHandlerBase, RoleTypeId, StartPosition,
                RagdollRotation, value, CreationTime);
        }
        ...
        public Quaternion RagdollRotation
        {
            ...
            set => RagdollData = new RagdollData(ReferenceHub, DamageHandlerBase, RoleTypeId, StartPosition, value,
                RagdollName, CreationTime);
        }
        ...
        public double CreationTime
        {
            ...
            set => RagdollData = new RagdollData(ReferenceHub, DamageHandlerBase, RoleTypeId, StartPosition,
                RagdollRotation, RagdollName, value);
        }
        ...
        public static bool Create(RagdollData networkInfo, [CanBeNull] out Ragdoll ragdoll)
        {
            ...
            if (modelRagdoll == null ||
                !Object.Instantiate(modelRagdoll).TryGetComponent(out BasicRagdoll basicRagdoll))
            {
                return false;
            }
        ...
        /// <param name="creationTime">The optional creation time of the ragdoll.</param>
        /// <returns>The created <see cref="Ragdoll" /> instance, or <c>null</c> if creation failed.</returns>
        public static Ragdoll CreateAndSpawn(string Nickname, RoleTypeId role, DamageHandlerBase damageHandlerBase,
            Player owner = null, Vector3 position = default, Quaternion rotation = default,
            double creationTime = default)
        {
            owner ??= Server.Host;
        ...
        {
            return Dictionary.TryGetValue(ragdollBase, out Ragdoll rag) ? rag : new Ragdoll(ragdollBase);
        }
