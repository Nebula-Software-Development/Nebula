...
{
    /// <summary>
    /// Gets a dictionary of all the <see cref="ReferenceHub"/> and <see cref="Npc"/>.
    /// </summary>
    public static new readonly Dictionary<ReferenceHub, Npc> Dictionary = new();
    ...
    /// <summary>
    /// Gets a collection of all the <see cref="Npc"/> instances.
    /// </summary>
    public static new IEnumerable<Npc> Collection => Dictionary.Values;

    /// <summary>
    /// Gets a list of all the <see cref="Npc"/> instances.
    /// </summary>
    public static new List<Npc> List => Collection.ToList();
    ...
    /// <returns></returns>
    public static Npc CreateNPC(string name, RoleTypeId role, int ID, string UserId = null, ClientInstanceMode clientInstanceMode = ClientInstanceMode.Host)
    {
        try
        {
